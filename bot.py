...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("👋 Доброго дня, {user_first_name}"
        "Спасибо, что согласились поучаствовать в моём проекте"
        "Что нужно сделать:\n"
        "1️⃣ Нажмите /gettext — получите случайный текст. Этот текст нужно переписать от руки и сфотографировать.\n"
"Постарайтесь фотографировать в хорошем освещении и чётко сверху.\n"
        "2️⃣ Отправьте фото (JPG или PNG), как вы обычно делаете это в телеграме.\n"
        "3️⃣ Дождитесь подтверждения загрузки.\n\n"
    )
